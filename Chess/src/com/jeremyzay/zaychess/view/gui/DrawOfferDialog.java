...
/**
 * Inline overlay shown when a draw is offered.
 */
public class DrawOfferDialog extends OverlayPanel {

    private final String message;
    private final Runnable onAccept;
    private final Runnable onDecline;

    public DrawOfferDialog(String message, Runnable onAccept, Runnable onDecline) {
    ...
    protected JPanel createContent() {
        ...
        // Title
        JLabel title = createTitle("Draw Offered");
